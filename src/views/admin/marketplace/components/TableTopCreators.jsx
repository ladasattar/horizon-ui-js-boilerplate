              ...
              <tr {...headerGroup.getHeaderGroupProps()} key={index}>
                {headerGroup.headers.map((column, index) => (
                  <th
                    ...
                    key={index}
                  >
                    <div className="flex items-center justify-between pt-4 pb-2 uppercase tracking-wide text-gray-600 text-start sm:text-xs lg:text-xs">
                ...
                <tr {...row.getRowProps()} key={index}>
                  {row.cells.map((cell, index) => {
                    ...
                    if (cell.column.Header === "Name") {
                      ...
                      data = (
                        <div className="mx-2 flex font-bold" key={index}>
